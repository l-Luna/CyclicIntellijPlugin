...
public class CyclicIcons{
	
	// TODO: get a proper icon/branding
	public static final Icon CYCLIC_ICON = IconLoader.getIcon("cyclic_icon.svg", CyclicIcons.class);
	
	public static final Icon CYCLIC_FILE = IconLoader.getIcon("cyclic_file.svg", CyclicIcons.class);
